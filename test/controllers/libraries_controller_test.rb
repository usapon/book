...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { book_name: @library.book_name, comp: @library.comp, date: @library.date, price: @library.price }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { book_name: @library.book_name, comp: @library.comp, date: @library.date, price: @library.price }
    assert_redirected_to library_path(assigns(:library))
  end
